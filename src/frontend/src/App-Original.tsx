...
// UserListing interface removed as it's not used in current implementation
...
const THEME = {
  ...
  glassmorphism: {
    ...
    panel: 'bg-emerald-100/30 dark:bg-emerald-900/20 backdrop-blur-xl border border-emerald-200/30 dark:border-emerald-700/30',
...
// UTILITY FUNCTIONS
// ================================
// Utility functions moved to where they're used to avoid unused variable errors

// reverseGeocode function moved inline to where it's used
...
const FloatingHeaderBar: React.FC<{
  ...
  return (
    <div
      className={`fixed top-6 left-1/2 -translate-x-1/2 z-50 flex items-center space-x-4 px-6 py-2 rounded-full ${THEME.glassmorphism.header} shadow-lg`}
    >
      <button
...
const HomePage: React.FC<{
  ...
  <>
    ...
    <section className="py-20 bg-gradient-to-br from-emerald-50/30 via-teal-50/30 to-cyan-50/30 dark:bg-gradient-to-br dark:from-emerald-950/50 dark:via-teal-950/50 dark:to-cyan-950/50">
    ...
    <section className="py-20 bg-gradient-to-br from-teal-50/50 via-emerald-50/50 to-cyan-50/50 dark:bg-gradient-to-br dark:from-teal-900/30 dark:via-emerald-900/30 dark:to-cyan-900/30">
        ...
        <div className="flex gap-4 items-center">
          <div className="flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-emerald-300 dark:border-emerald-600 rounded-lg bg-emerald-50/50 dark:bg-emerald-800/30 text-slate-800 dark:text-slate-200 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 backdrop-blur-sm"
            />
    </div>
          {locationFilter && (
            <button
              onClick={() => setLocationFilter('')}
              className="mt-6 px-3 py-2 text-sm bg-emerald-200 dark:bg-emerald-700 text-emerald-800 dark:text-emerald-200 rounded-lg hover:bg-emerald-300 dark:hover:bg-emerald-600 transition-colors"
            >
              Clear
            </button>
          )}
...
const AboutPage: React.FC = () => (
  <div className="bg-gradient-to-br from-emerald-50/30 via-teal-50/30 to-cyan-50/30 dark:bg-gradient-to-br dark:from-emerald-950/50 dark:via-teal-950/50 dark:to-cyan-950/50">
...
const BecomeSellerPage: React.FC<{ onStartSellingClick: () => void }> = ({
  ...
  return (
    <>
      <div className="bg-gradient-to-br from-teal-50/50 via-emerald-50/50 to-cyan-50/50 dark:bg-gradient-to-br dark:from-teal-900/30 dark:via-emerald-900/30 dark:to-cyan-900/30">
        ...
        <div className="py-20 bg-gradient-to-br from-emerald-50/30 via-teal-50/30 to-cyan-50/30 dark:bg-gradient-to-br dark:from-emerald-950/50 dark:via-teal-950/50 dark:to-cyan-950/50">
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-10 max-w-5xl mx-auto">
              <div className="text-center">
                <div className="w-20 h-20 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold">
                  1
                </div>
...
const SellItemModal: React.FC<{ isOpen: boolean; onClose: () => void }> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-emerald-50/30 dark:bg-emerald-900/20 dark:text-slate-100 backdrop-blur-xl border border-emerald-200/30 dark:border-emerald-700/30 rounded-3xl shadow-xl m-4 sm:max-w-xl sm:w-full z-10 p-8 transform transition-all duration-300 ease-in-out animate-fadeInUp"
      ...
      >
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            onClick={onClose}
            className="text-slate-500 hover:text-slate-800 dark:text-slate-300 dark:hover:text-white bg-emerald-100/40 dark:bg-emerald-800/40 border border-emerald-200/30 dark:border-emerald-700/30 backdrop-blur-xl rounded-full p-2"
          >
            <X />
          </button>
        </div>
        <form onSubmit={handleSubmit}>
          ...
          <input
              ...
              className="w-full px-4 py-2 border border-emerald-300 dark:border-emerald-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 dark:bg-emerald-800/30 dark:text-slate-100 bg-emerald-50/50 backdrop-blur-sm"
          ...
          <div className="mb-4">
            ...
            <div className="flex space-x-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-emerald-500 hover:bg-emerald-600 disabled:bg-emerald-300 text-white rounded-lg transition-colors duration-200 flex items-center space-x-1"
              >
                <span>📍</span>
          ...
          <div className="mb-6">
            ...
            <button
              ...
              className="mt-2 flex items-center justify-center text-slate-800 dark:text-white font-semibold py-2 px-5 rounded-full bg-emerald-100/40 dark:bg-emerald-800/50 border border-emerald-200/30 dark:border-emerald-700/30 backdrop-blur-xl hover:bg-emerald-200/60 dark:hover:bg-emerald-700/70 transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <div className="flex justify-end">
            <button
              type="submit"
              className="text-white font-semibold py-2 px-6 rounded-full bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
            >
              List Item
            </button>
          </div>
...
const WishlistPanel: React.FC<{
  ...
  return (
    <>
      ...
      />
      <div
        className={`fixed top-0 right-0 h-full w-full max-w-md bg-emerald-100/30 dark:bg-emerald-900/20 backdrop-blur-xl border-l border-emerald-200/30 dark:border-emerald-700/30 shadow-2xl z-50 transform transition-transform duration-500 ease-in-out ${isOpen ? 'translate-x-0' : 'translate-x-full'} flex flex-col rounded-l-3xl`}
      >
            ...
            {wishlistItems.map((item) => (
              <div key={item.id} className="flex items-center space-x-4 animate-fadeIn">
                ...
                <button
                  ...
                  className="text-slate-400 hover:text-red-500 bg-emerald-100/40 dark:bg-emerald-800/40 border border-emerald-200/30 dark:border-emerald-700/30 backdrop-blur-xl rounded-full p-2"
                >
                  <Trash2 />
                </button>
              </div>
...
const DashboardPanel: React.FC<{
      ...
      case 'overview':
        return (
          <div className="p-6 space-y-4">
            <div className="bg-emerald-50/40 dark:bg-emerald-800/40 backdrop-blur-xl rounded-xl p-4 border border-emerald-200/30 dark:border-emerald-700/30">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-emerald-100/60 dark:bg-emerald-900/30 backdrop-blur-xl p-4 rounded-lg">
                <h3 className="font-semibold text-emerald-800 dark:text-emerald-200">Active Listings</h3>
                <p className="text-2xl font-bold text-emerald-600">{userListings.filter(l => l.isActive).length}</p>
              </div>
  ...
  return (
    <>
      ...
      />
      <div
        className={`fixed top-0 left-0 h-full w-full max-w-md bg-emerald-100/30 dark:bg-emerald-900/20 backdrop-blur-xl border-r border-emerald-200/30 dark:border-emerald-700/30 shadow-2xl z-[60] transform transition-transform duration-500 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'} flex flex-col rounded-r-3xl`}
      >
        <div className="p-6 border-b flex justify-between items-center">
...
const FloatingIconButton: React.FC<{ onClick: () => void; children: React.ReactNode }> = ({ onClick, children }) => (
  <button
    onClick={onClick}
    className="p-3 rounded-full backdrop-blur-xl bg-emerald-100/50 dark:bg-emerald-900/40 border border-emerald-200/30 dark:border-emerald-700/30 shadow-lg hover:shadow-xl text-slate-800 dark:text-slate-200 transition-all duration-300"
  >
    {children}
  </button>
)
        ...
        <div className="mt-8">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-emerald-100/10 dark:bg-emerald-900/20 backdrop-blur-sm text-slate-500 dark:text-slate-400 rounded-full">
           ...
           <div className="relative">
            ...
            <input
              autoFocus
                 ...
                 className="w-full pl-12 pr-12 py-3 rounded-2xl bg-white/20 dark:bg-slate-800/30 backdrop-blur-xl border border-white/30 dark:border-slate-700/30 text-slate-800 dark:text-slate-100 placeholder-slate-500 dark:placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 transition-all duration-200 shadow-lg"
               />
               {/* Search Icon */}
               <div className="absolute top-1/2 -translate-y-1/2 left-4 text-slate-500 dark:text-slate-400 pointer-events-none">
             ...
             {searchSuggestions.length > 0 && (
               <div className="absolute mt-2 w-full bg-emerald-100/20 dark:bg-emerald-900/30 backdrop-blur-xl border border-emerald-200/30 dark:border-emerald-700/30 rounded-2xl shadow-lg overflow-hidden">
                 {searchSuggestions.map((p) => (
                   <button
                     ...
                     className="w-full text-left px-4 py-3 hover:bg-emerald-100/20 dark:hover:bg-emerald-800/40 text-slate-800 dark:text-slate-100 transition-colors first:rounded-t-2xl last:rounded-b-2xl"
                   >
